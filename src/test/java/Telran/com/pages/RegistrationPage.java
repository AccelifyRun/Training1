...
public class RegistrationPage extends Page {
    ...
    */
    ...
    public boolean alertMessageRequiredEmail() {
        return exists(wrongEmailAlert);
    }

    public boolean alertMessageNotValiddEmail() {
        return exists(formatMailWrong);
    }

    public boolean alertMessageNotValidPassword() {
        return exists(passwordWrong);
    }

    public boolean alertMessageRequiredPassword() {
        return exists(wrongPasswordAlert);
    }

    public boolean alertMessageRequiredConfirmPassword() {
        return exists(wrongConfirmPasswordAlert);
    }

    public boolean alertMessageNotValidConfirmPassword() {
        return exists(wrongConfirmPassword);
    }

    public boolean alertMessageNotValidZeut() {
        return exists(wrongValidatorID);
    }

    public boolean alertMessageRequiredZeut() {
        return exists(wrongValidatorIDAlert);
    }

    public boolean alertMessageRequiredHouse() {
        return exists(wrongValidatorBaitAlert);
    }

    public boolean alertMessageNotReqMobile() {
        return exists(wrongValidatorMobileAlert);
    }

    public boolean alertMessageNotValidStreet() {
        return exists(wrongValidatorStreetAlert);
    }

    public boolean alertMessageNotValidCity() {
        return exists(wrongValidatorCityAlert);
    }
